...
use dockworker::{models::{AttachContainer, ContainerCreateOptions, ContainerHostConfig}, Docker};
...
fn main() {
  ...
  let res = docker.container_attach(&container.id, None, true, true, false, true, false)
                  .unwrap();
